...
export type AuditControlCategory = "security" | "authentication" | "authorization" | "secrets" | "api-boundary" | "cors" | "jwt-session" | "database-migrations" | "dependency-hygiene" | "testing" | "ci-cd" | "observability" | "error-handling" | "ai-provider-safety" | "cost-rate-limits" | "release-governance" | "provenance" | "auditability" | "rollback" | "organization-approval" | "remote-attestation" | "retention";
export type AuditEvidenceSourceName = "ledger" | "security-policy" | "scanner-results" | "external-scanner-results" | "verification-results" | "ci-status" | "deployment-readiness" | "release-readiness" | "provenance" | "evidence" | "remote-attestation" | "transparency" | "registry-metadata" | "organization-policy" | "organization-approval" | "retention" | "organization-audit" | "handoff" | "release-packet" | "git-lifecycle" | "reviewer-feedback" | "merge-readiness";
