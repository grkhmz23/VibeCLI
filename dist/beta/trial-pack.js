...
export async function createBetaTrialPack(cwd, target = "solo-developer") {
    ...
    await writeFile(join(dir, "BETA_FEEDBACK_TEMPLATE.md"), "# Beta Feedback\n\n- What worked?\n- What failed?\n- What felt unsafe or unclear?\n", "utf8");
    await writeFile(join(dir, "BETA_INCIDENT_TEMPLATE.md"), "# Beta Incident\n\n- Summary:\n- Command:\n- Expected:\n- Actual:\n- Local artifacts to attach:\n", "utf8");
    await writeFile(join(dir, "BETA_TRIAL_CHECKLIST.md"), "# Trial Checklist\n\n- [ ] Install locally\n- [ ] Run dry-run workflow\n- [ ] Review safety prompts\n- [ ] Submit feedback template\n", "utf8");
    return summary;
}
export async function listBetaTrials(cwd) {
...
export async function showBetaTrial(cwd, trialId) {
...
//# sourceMappingURL=trial-pack.js.map