export declare const betaChannels: readonly ["private-beta", "closed-beta", "public-beta"];
...
export type BetaState = {
    updatedAt: string;
    latestBetaVerdict: "beta_rc_ready" | "ready_with_accepted_warnings" | "ready_with_warnings" | "blocked" | "unknown";
...
export type BetaWarningRecord = {
    id: string;
    source: string;
    category: "docs" | "scanner" | "live-provider" | "dogfood" | "package" | "security" | "performance" | "ux" | "other";
