...
export function registerDisposalEligibilityCommand(program) {
    program
        ...
        if (!runId)
            throw new Error("Run id is required unless --all is used.");
...
//# sourceMappingURL=disposal-eligibility.js.map