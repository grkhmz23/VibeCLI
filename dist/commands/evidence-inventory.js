...
export function registerEvidenceInventoryCommand(program) {
    program
        ...
        if (!runId)
            throw new Error("Usage: vibe evidence-inventory <run-id>");
...
//# sourceMappingURL=evidence-inventory.js.map