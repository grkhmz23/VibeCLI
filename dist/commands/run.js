...
export function registerRunCommand(program) {
    program
        ...
        .option("--max-cost-usd <amount>", "Phase 2 tracking only; exact provider billing is not implemented")
        ...
        if (options.executeSafeCommands) {
            console.log("Safe command execution is reserved; no LLM-recommended commands were executed.");
        }
