...
export async function runPackageCheck(cwd) {
    const checks = [];
    ...
    try {
        ...
        checks.push({
            ...
            status: out.includes(".env") || out.includes(".private.pem") || out.includes(".vibecli/keys")
                ? "failed"
                : "passed",
    ...
    await import("node:fs/promises").then((fs) => fs.writeFile(join(cwd, ".vibecli", "dogfood", "reports", "PACKAGE_CHECK.md"), `# Package Check\n\nPassed: ${report.summary.passed}\nWarnings: ${report.summary.warnings}\nFailed: ${report.summary.failed}\n\nNo package was published.\n`, "utf8"));
