...
export function validateDisposalConfig(config) {
    const errors = [];
    if (!underVibe(config.disposal_dir)) {
        errors.push("evidence_disposal.disposal_dir must be under .vibecli/evidence-lifecycle/disposal");
    }
...
function underVibe(path) {
    return (path === ".vibecli/evidence-lifecycle/disposal" ||
