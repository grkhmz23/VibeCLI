...
export type EvidenceClass = "run-ledger" | "patches" | "rollback" | "verification" | "scanner" | "handoff" | "git-lifecycle" | "release" | "provenance" | "evidence" | "remote-attestation" | "organization" | "audit" | "console" | "unknown";
...
export type RetentionEnforcementPreview = {
    ...
    eligibleForArchive: Array<{
        path: string;
        class: string;
        reason: string;
    }>;
    blockedFromArchive: Array<{
        path: string;
        reason: string;
    }>;
...
export type RetentionLedgerEvent = {
    version: 1;
    createdAt: string;
    eventType: "inventory_generated" | "retention_previewed" | "archive_created" | "archive_verified" | "legal_hold_enabled" | "legal_hold_released" | "compaction_reported" | "compaction_bundle_created" | "disposal_eligibility_checked" | "disposal_candidates_generated" | "disposal_plan_created" | "disposal_attestation_created" | "disposal_approval_added" | "disposal_precheck_passed" | "disposal_executed" | "disposal_receipt_recorded";
    runId: string;
    actor: string | null;
    summary: string;
