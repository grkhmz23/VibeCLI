...
export function fixtureDefinition(type: DogfoodFixtureType): FixtureDefinition {
  switch (type) {
    case "node-package":
      return nodePackage();
    case "vite-react":
...
function nodePackage(): FixtureDefinition {
  return {
    type: "node-package",
    files: [
      [
...
function viteReact(): FixtureDefinition {
  return {
    type: "vite-react",
    files: [
      [
...
function expressApi(): FixtureDefinition {
  return {
    type: "express-api",
    files: [
      [
...
function nextApp(): FixtureDefinition {
  return {
    type: "nextjs-app",
    files: [
      [
...
function pythonPackage(): FixtureDefinition {
  return {
    type: "python-package",
    files: [
      [
...
function rustCrate(): FixtureDefinition {
  return {
    type: "rust-crate",
    files: [
      [
...
function solanaAnchor(): FixtureDefinition {
  return {
